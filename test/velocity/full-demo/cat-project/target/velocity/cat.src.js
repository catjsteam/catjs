...
_cat.core.define("C:.Users.snirr.workspace.CATCore.test.velocity.full-demo.cat-project.target.velocity.index.html.clickLogin", function() {

  var pkgName = "C:.Users.snirr.workspace.CATCore.test.velocity.full-demo.cat-project.target.velocity.index.html.clickLogin";

  return {

    /**
     * Init functionality for scrap C:.Users.snirr.workspace.CATCore.test.velocity.full-demo.cat-project.target.velocity.index.html.clickLogin
     *
     * @param content CAT Context object
     */
    init: function(context) {
